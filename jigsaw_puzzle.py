...
while True:
    ...
    if event.type == MOUSEBUTTONDOWN:
        outl1[0] = 100 + jen1.get_width()
        outl2[0] = 100 + jen1.get_height()
        outl1[1] = 400 + mif.get_width()
        outl2[1] = 400 + mif.get_height()
        if loc1 < outl1[0] and loc1 > 100 and loc2 < outl2[0] and loc2 > 100:
            pygame.display.quit()
            resp = 1
            break
        elif loc1 < outl1[1] and loc1 > 400 and loc2 < outl2[1] and loc2 > 400:
            pygame.display.quit()
            resp = 2
            break
...
while True:
    ...
    screen.lock()
    pygame.draw.rect(screen,(0,102,102),Rect((400,70),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((400,130),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((400,190),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((460,70),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((460,130),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((460,190),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((520,70),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((520,130),(60,60)))
    pygame.draw.rect(screen,(0,102,102),Rect((520,190),(60,60)))
    screen.unlock()
